...
def scoring_check():
    """
    Perform a scoring check by evaluating the model across different slices of the dataset based on categorical features.
    """
    ...
    for category in categorical_features:
        for category_value in test_data[category].unique():
            ...
            x_test, y_test, _, _ = process_data(
                slice_data_frame, categorical_features=categorical_features, label='salary', training=False, encoder=encoder, label_binarizer=label_binarizer)
